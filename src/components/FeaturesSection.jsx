...
export default function FeaturesSection() {
  return (
    <section id="features" className="relative py-28 bg-white border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <h2 className="font-display text-3xl sm:text-5xl font-extrabold tracking-tight text-slate-900 mb-4">
            Everything You Need to <span className="text-[#0078d4]">Ship Great Software</span>
          </h2>
        ...
        {/* Microsoft Fluent Capabilities Grid */}
          ...
          {BENTO_FEATURES.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className="fluent-card p-8 rounded-xl flex flex-col justify-between group"
              >
                <div>
                  {/* Category Pill & Icon */}
                  <div className="flex items-center justify-between mb-6">
                    <span className="text-[10px] font-mono tracking-wider text-[#0078d4] bg-blue-50 font-bold px-2.5 py-1 rounded uppercase">
                      {item.category}
                    </span>
                    <div className="p-3 rounded-lg bg-slate-100 border border-slate-200 text-slate-700 group-hover:text-[#0078d4] group-hover:bg-blue-50 transition-colors">
                ...
                <div className="pt-4 border-t border-slate-100 flex items-center justify-between text-xs font-mono text-slate-500">
                  <span className="text-[#7fba00] font-bold">{item.badge}</span>
                  <span className="text-[#0078d4] font-semibold">Verified Spec</span>
                </div>
              </motion.div>
            );
          })}
