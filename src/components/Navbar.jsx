  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-1 bg-white/80 p-1.5 rounded-lg border border-slate-200/80 backdrop-blur-md shadow-xs">
          {NAV_ITEMS.map((item) => {
        ...
        <div className="flex lg:hidden items-center">
          <button
            ...
            className="p-2 rounded-md bg-white border border-slate-200 text-slate-700 hover:text-slate-900 focus:outline-none shadow-xs"
        ...
        <div className="lg:hidden bg-white/95 backdrop-blur-xl border-b border-slate-200 px-4 pt-4 pb-6 mt-2 space-y-2 shadow-xl">
            ...
            if (item.isRoute) {
              return (
                <Link
                  ...
                  className="block px-4 py-2.5 rounded-md text-sm font-semibold text-slate-700 hover:bg-slate-100 hover:text-[#0078d4] transition-colors"
                >
                  {item.label}
                </Link>
              );
          ...
          <div className="pt-2">
            <a
              href="#contact"
              onClick={(e) => handleNavClick(e, { href: '#contact' })}
              className="block w-full text-center py-2.5 rounded-md text-sm font-bold text-white bg-[#0078d4] shadow-sm"
            >
              Contact AirDive
            </a>
          </div>
